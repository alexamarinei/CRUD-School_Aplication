...
<title>Actualizare Corector</title>
</head>
<style>
body {
...
$prenumeCorector = $_GET['prenumeCorector'];
$cnpCorector= $_GET['cnpCorector'];
$adresaCorector = $_GET['adresaCorector'];
$telefonCorector = $_GET['telefonCorector'];
?>

<body>

<form action="actualizareCorectorOp.php" method="get">

<table class="tg" style="margin: 10px auto;">
<?php
echo '<input type="hidden" name="idCorector" value="'.$idCorector.'">';
echo "<tr>";
echo '<th class="tg-baqh" colspan="2" >Actualizare Corector</th>';
echo "</tr>";
echo "<tr>";
echo '<td class="tg-6k2t">Nume</td>';
echo '<td class="tg-6k2t"><input type="text" name="numeCorector" value="'.$numeCorector.'"size="40"><br></td>';
echo "</tr>";
echo "<tr>";
echo '<td class="tg-6k2t">Prenume</td>';
echo '<td class="tg-6k2t"><input type="text" name="prenumeStudent" value="'.$prenumeCorector.'"size="40"><br></td>';
echo "</tr>";
echo "<tr>";
echo '<td class="tg-6k2t">Cnp</td>';
echo '<td class="tg-6k2t"><input type="text" name="cnpStudent" value="'.$cnpCorector.'"size="40"><br></td>';
echo "</tr>";
echo "<tr>";
echo '<td class="tg-6k2t">Adresa</td>';
echo '<td class="tg-6k2t"><input type="text" name="adresaStudent" value="'.$adresaCorector.'"size="40"><br></td>';
echo "</tr>";
echo "<tr>";
echo '<td class="tg-6k2t">Telefon</td>';
echo '<td class="tg-6k2t"><input type="text" name="telefonStudent" value="'.$telefonCorector.'"size="40"><br></td>';
echo "</tr>";
echo "<tr>";
echo "<tr>";

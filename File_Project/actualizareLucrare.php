...
<title>Actualizare Lucrare</title>
</head>
<style>
body {
...
<form action="actualizareLucrareOp.php" method="get">

<table class="tg" style="margin: 10px auto;">
<?php
echo '<input type="hidden" name="idLucrare" value="'.$idLucrare.'">';
echo "<tr>";
echo '<th class="tg-baqh" colspan="2" >Actualizare Lucrare</th>';
echo "</tr>";
echo "<tr>";
echo '<td class="tg-6k2t">Nume</td>';
echo '<td class="tg-6k2t"><input type="text" name="numeLucrare" value="'.$numeLucrare.'"size="40"><br></td>';
echo "</tr>";
echo "<tr>";
echo '<td class="tg-6k2t">Nota</td>';
echo '<td class="tg-6k2t"><input type="text" name="nota" value="'.$nota.'"size="40"><br></td>';
echo "</tr>";
echo "<tr>";
